...
<div class="row-fluid">
    ...
    <div class="alert alert-info">
        ...
        <strong>Welcome Back:</strong> System Admin Home!
    </div>
...
<div class="row-fluid">
    <div class="block span6">
        <a href="#tablewidget" class="block-heading" data-toggle="collapse">Affiliate Programmer<span class="label label-warning">+10</span></a>
        ...
        <div id="widget2container" class="block-body collapse in">
            <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                      <td>
                          <p><i class="icon-user"></i>jhemy Wilson</p>
                      </td>
                      <td>
                          <p>Total sales: $1,192</p>
                      </td>
