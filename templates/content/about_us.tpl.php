<hr class="soften">
<h1 style="text-align:right">About us</h1>
<div class="row">
<div class="span12">
	<ul id="myTab" class="nav nav-tabs">
	  <li class="active"><a href="#s1" data-toggle="tab">Section One</a></li>
	  <li class=""><a href="#s2" data-toggle="tab">Section Two</a></li>
	  <li class=""><a href="#s3" data-toggle="tab">Section Three </a></li>
	</ul>
	</div>
<div class="span12">
